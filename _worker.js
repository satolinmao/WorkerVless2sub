...
// 设置优选地址api接口
let addressesapi = [
	'https://2999a301.cf-workers-text2kv-9d2.pages.dev/iptxt.txt?token=222636910', //可参考内容格式 自行搭建。
...
let DLS = 8;//速度下限
let addressescsv = [
	/'https://2999a301.cf-workers-text2kv-9d2.pages.dev/iptxt.txt?token=222636910', //iptest测速结果文件。
];
